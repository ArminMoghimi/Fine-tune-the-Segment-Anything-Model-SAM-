...
Some examples of river water segmentation results on the LuFI-RiverSnap.\textit{v}1. (a) Images and segmentation results generated by (b) U-Net$_{\text{(ResNet50)}}$, (c) PSPNet$_{\text{(ResNet50)}}$, (d) DeeplabV3+$_{\text{(ResNet50)}}$, (e) PAN$_{\text{(ResNet50)}}$, (f) LinkNet$_{\text{(ResNet50)}}$, and (g) SAM were used as DL models for river water segmentation.Green: False Positives ($FP$) detection, Pink: False Negatives ($FN$) detection, Blue: correct detection of river water.
